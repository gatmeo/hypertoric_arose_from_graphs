...
\section{Cohomology}
\begin{theorem}[thm:cohomology_hypertoric]{}
...
\begin{proposition}[pps:]{}
    ...
    \begin{proof}
        ...
        On the other hand,
        by \Cref{pps:tautological_line_bundle_T_weight}, the $T$-weights of $\NN^+_{p_B}$ and $\NN^{1/2}_{p_B}$ are $\CB{\fundcyclewithtree{i}}_{i\in B^*_+}\cup \CB{-\fundcyclewithtree{i}}_{i\in B^*_-}$ and $\CB{\fundcyclewithtree{i}}_{i\in B^*}$ respectively.
