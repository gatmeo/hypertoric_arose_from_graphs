...
\missing{When $\lambda\neq 0$ is generic, all points are semistable.}
...
The definition of \Cref{eq:exact_sequence_tori_graph} does not depend on a choice of basis of $\im(d_{\Gamma,\mathbb{C}^\times })$ and $\HH^1(\Gamma,\mathbb{C}^\times )$. However, fixing bases allows us to describe a split of the exact sequence, and hence the $T$-fix points.
